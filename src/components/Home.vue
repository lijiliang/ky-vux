<template>
  <div>
    ...
    <group>
      <cell title="Live Demo" link="/new">
        <span class="icon icon-Kyani" slot="icon" style="color:#F70968"></span>
      </cell>
    </group>
    <group>
      <cell title="Buy me a coffee" link="project/donate">
        <span class="icon icon-shoppingCart" slot="icon" style="color:red;"></span>
        <!-- <badge text="donate"></badge> -->
      </cell>
      <cell title="Github" link="http://github.com/airyland/vux" value="Star me">
        <span class="icon icon-news" slot="icon" style="color:#35495e;"></span>
      </cell>
    </group>
    <br>
    <p class="vue-version">current vue version</p>
  </div>
</template>
